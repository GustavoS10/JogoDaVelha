...
let buttons = document.querySelectorAll('#bc button');

let messageContainer = document.querySelector("#men");
let messageText = document.querySelector("#men p");
let msgC = document.querySelector("#men2");
let msgText2 = document.querySelector("#men2 h2");
...
for(let i = 0; i < buttons.length; i++) {
  ...
  buttons[i].addEventListener("click", function() {
    ...
    setTimeout(function() {
      ...
      let h2 = document.querySelector("#M2");
      let xo = document.querySelector("#xo");

      container.classList.remove("hide");
      h2.classList.remove("hide");
      xo.classList.remove("hide");
      msgText2.innerHTML = msg1 + msg2;
